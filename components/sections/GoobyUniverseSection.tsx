    ...
    <div ref={container}>
      ...
      <section className="fisico-digital w-full overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto px-6 text-center py-20 md:py-32">
          <p className="font-[family-name:var(--font-playfair)] text-[var(--color-champagne)] text-lg italic leading-loose mt-32 mb-96">
      ...
      <section className="w-full py-32 md:py-48 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          {/* Three big words */}
          <div className="sentimiento-words space-y-6 mb-24">
            {[
